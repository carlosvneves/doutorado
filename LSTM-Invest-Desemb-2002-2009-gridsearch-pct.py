...
def eval_model(data, cfg, n_rep=10):
      ...
      model.save("model-pct-{}-{}.h5".format(series_par,model_par))  
...
def load_best_model():
    ...
    best_file = 'model-pct-{}-n_endog,{}-n_quarters,{}-n_train_quarters,{}-n_features-{}-n_nodes,{}-n_epochs,{}-n_batch.h5'.format(best_par[0],
                                                                                                                                    best_par[1],
                                                                                                                                    best_par[2],
                                                                                                                                    best_par[3],
                                                                                                                                    best_par[4],
